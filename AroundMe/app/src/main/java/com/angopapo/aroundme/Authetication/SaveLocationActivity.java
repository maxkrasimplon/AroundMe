...
import com.angopapo.aroundme.Passport.ManuelMapsActivity;
...
public class SaveLocationActivity extends AppCompatActivity implements ActivityWithToolbar, View.OnClickListener {

    public static final int REQUEST_CODE_LOCATION = 103;
    private static final int REQUEST_EXTERNAL_LOCATION = 19 ;
    ...
    Button mTravelButton, mManualButton, mRefreshButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mManualButton = (Button) findViewById(R.id.button_manuel);
        ...
        aroundMeLocationService = new AroundMeLocationService(SaveLocationActivity.this);
        ...
        if (isInternetAvailable()) {
            switch (v.getId()) {
                ...
                case R.id.privacyButton:
                    ...
                    Intent loginIntent = new Intent(SaveLocationActivity.this, PrivacyActivity.class);
                    SaveLocationActivity.this.startActivity(loginIntent);
                    //LocationFound.this.finish();

                    break;

                case R.id.button_manuel:

                    Intent intent1 = new Intent(SaveLocationActivity.this, ManuelMapsActivity.class);
                    SaveLocationActivity.this.startActivity(intent1);
                    //LocationFound.this.finish();
                ...
                case R.id.button_travel:
                    ...
                    if (mCurrentLocation != null) {
                                        ...
                                        case ParseException.SESSION_MISSING:
                                            ...
                                            Snackbar.make(mLocationLayout, R.string.seesion_missing, Snackbar.LENGTH_INDEFINITE).setAction("OK", new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    Intent intent = new Intent(SaveLocationActivity.this, DispatchActivity.class);
                        ...
                        AlertDialog.Builder notifyLocationServices = new AlertDialog.Builder(SaveLocationActivity.this);
                        ...
                        notifyLocationServices.setPositiveButton(getString(R.string.location_on), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                SaveLocationActivity.this.startActivity(openLocationSettings);
                                //LocationFound.this.finish();
                                //finish();
                            }
                        });
    ...
    public void checkGPS(){
        ...
        LocationManager lm = (LocationManager)SaveLocationActivity.this.getSystemService(Context.LOCATION_SERVICE);
        ...
        if(!gps_enabled && !network_enabled) {
            // notify user
            AlertDialog.Builder dialog = new AlertDialog.Builder(SaveLocationActivity.this);
            dialog.setMessage(R.string.gps_not);
            dialog.setPositiveButton(R.string.nable_gps, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                    // TODO Auto-generated method stub
                    Intent myIntent = new Intent( Settings.ACTION_LOCATION_SOURCE_SETTINGS);
                    SaveLocationActivity.this.startActivity(myIntent);
                    //get gps
                }
            });
            dialog.setNegativeButton(R.string.dont, new DialogInterface.OnClickListener() {
    ...
    public void PermissionRequestLocation(){
        ...
        if (ContextCompat.checkSelfPermission(SaveLocationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(SaveLocationActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {

                new android.app.AlertDialog.Builder(SaveLocationActivity.this)
                        .setTitle(R.string.pernedd)
                        .setMessage(R.string.perstorage)
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {

                                ActivityCompat.requestPermissions(SaveLocationActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_EXTERNAL_LOCATION);
                            }
                        })
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Context context = SaveLocationActivity.this;
                    CharSequence text = getString(R.string.pemidenny);
