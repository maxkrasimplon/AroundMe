...
public class ManuelMapsActivity extends AppCompatActivity implements ActivityWithToolbar, OnMapReadyCallback, SearchView.OnQueryTextListener, SearchAddressFragment.SearchAddressListener, View.OnClickListener {


    public static final int REQUEST_CODE_LOCATION = 1001;
    private static final int REQUEST_EXTERNAL_LOCATION = 12366;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_manuel);
        ...
        getSupportActionBar().setTitle(R.string.where_are_you);
        ...
        switch (v.getId()){
            case R.id.button_save_location:
                ...
                if (isInternetAvailable()) {
                    ...
                    showProgressBar(getString(R.string.manuel_location));
                                ...
                                if (e != null) {
                                    switch (e.getCode()) {
                                        ...
                                        case ParseException.OTHER_CAUSE:
                                            ...
                                            Snackbar.make(mSettingsLayout, R.string.loc_intererror, Snackbar.LENGTH_INDEFINITE).setAction("OK", new View.OnClickListener() {
                                                @Override
                                                public void onClick(View v) {
                                        ...
                                        case ParseException.SESSION_MISSING:
                                            ...
                                            Snackbar.make(mSettingsLayout, R.string.seesion_missing, Snackbar.LENGTH_INDEFINITE).setAction("OK", new View.OnClickListener() {
                                                @Override
                                                public void onClick(View v) {
                                                    ...
                                                    Intent intent = new Intent(ManuelMapsActivity.this, DispatchActivity.class);
                                                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                                    startActivity(intent);
                                                    ManuelMapsActivity.this.finish();
                                    ...
                                    Intent loginIntent = new Intent(ManuelMapsActivity.this, AroundMeActivity.class);
                                    ManuelMapsActivity.this.startActivity(loginIntent);
                                    ManuelMapsActivity.this.finish();
    ...
    public void PermissionRequestLocation(){
        ...
        if (ContextCompat.checkSelfPermission(ManuelMapsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(ManuelMapsActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {

                new android.app.AlertDialog.Builder(ManuelMapsActivity.this)
                        .setTitle("Permission Needed")
                        .setMessage("Storage location is needed to access your gallery to update your profile picture")
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {

                                ActivityCompat.requestPermissions(ManuelMapsActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_EXTERNAL_LOCATION);
                            }
                        })
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Context context = ManuelMapsActivity.this;
