...
public  class TravelActivity extends AppCompatActivity implements ActivityWithToolbar, View.OnClickListener, InterstitialAdListener {

    final Context context = this;

    TextView  mGetVipButton;

    Button mTravelButton, mButtonBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interstitialAd = new InterstitialAd(TravelActivity.this, getString(R.string.fb_audiance_travel));

        // Set a listener to get notified on changes or when the user interact with the ad.
        interstitialAd.setAdListener(TravelActivity.this);
    ...
    protected void startMapsActivity() {
        Intent whoSeeIntent = new Intent(this, MapsActivity.class);
