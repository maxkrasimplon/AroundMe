...
public  class PrivateModeActivity extends AppCompatActivity implements ActivityWithToolbar, View.OnClickListener, InterstitialAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interstitialAd = new InterstitialAd(PrivateModeActivity.this, getString(R.string.fb_audiance_private));

        // Set a listener to get notified on changes or when the user interact with the ad.
        interstitialAd.setAdListener(PrivateModeActivity.this);
